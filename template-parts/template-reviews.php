							...
							if ( $posts ) :
								foreach ( $posts as $post ) : ?>
                                    <div class="swiper-slide">
                                        <div class="row">
                                            <div class="col-12">
                                                <img src="https://by.stakhanovets.com/wp-content/uploads/2024/08/stkh-logo.svg"
                                                     alt="Логотип"
                                                     class="img-fluid">
                                            </div>
                                        ...
                                        <div class="row d-flex fl align-items-center mt-5">
                                            <div class="col-auto">
                                                <img src="https://by.stakhanovets.com/wp-content/uploads/2024/08/review_user_avatar.svg"
                                                     alt="Логотип"
